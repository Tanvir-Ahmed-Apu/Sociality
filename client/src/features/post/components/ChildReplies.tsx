...
const ChildReplies = ({ 
  ...
  sortedChildReplies = sortedChildReplies.sort((a, b) => {
    ...
    const aReplies = allReplies.filter((r:any) => r.parentReplyId === a._id).length;
    const bReplies = allReplies.filter((r:any) => r.parentReplyId === b._id).length;
      ...
      {sortedChildReplies.map((childReply, index) => (
        <Box key={childReply._id}>
          ...
          <Comment
            ...
            childReplies={allReplies.filter((r:any) => r.parentReplyId === childReply._id)}
