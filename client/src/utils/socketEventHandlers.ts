 ...
 */
export const handleNewMessage = (data: any, updateMessages: (fn: (prev: any[]) => any[]) => void, showToast: any) => {
 ...
 * @param {function} showToast - Function to show toast notification
 */
export const handleNewNotification = (data: any, updateNotifications: (fn: (prev: any[]) => any[]) => void, showToast: any) => {
 ...
 */
export const handlePostUpdate = (data: any, updatePosts: (fn: (prev: any[]) => any[]) => void) => {
 ...
 */
export const handleUserStatusChange = (data: any, updateOnlineUsers: (fn: (prev: any[]) => any[]) => void) => {
  if (data.online) {
