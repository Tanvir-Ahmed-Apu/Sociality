...
const OnboardingRoute = ({ children }: { children: React.ReactNode }) => {
  ...
  useEffect(() => {
    const checkProfileCompletion = async () => {
      ...
      // If the atom already says the profile is complete, skip the API call entirely.
      // This prevents the spinner from blocking navigation after profile updates.
      if (user.isProfileComplete === true) {
        setProfileStatus({ isProfileComplete: true });
        setLoading(false);
        return;
      }
