...
export async function announceRoom(roomId: string, roomName: string) {
  try {
...
export async function getRoomPeers(roomId: string) {
  try {
...
export async function getMessagesFromPeer(peerUrl: string, roomId: string, since: string) {
  try {
...
export async function relayMessageToFederation(roomId: string, message: any) {
  try {
